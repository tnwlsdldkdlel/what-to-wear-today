...
1. **착장 데이터 제출 플로우**
   ...
   _착장 데이터 제출 플로우: SVG 기반 직관적 UI로 단계별 선택_
   </div>
...
2. **날씨 기반 추천 시스템**
   ...
   _홈 화면: 날씨 정보, 인기 착장 추천, 카테고리별 추천 / 지역 선택: GPS 또는 수동 선택_
   </div>
...
3. **인기 착장 추천**
   ...
   _인기 착장 추천은 홈 화면 상단에 표시됨 (위 홈 화면 이미지 참조)_
